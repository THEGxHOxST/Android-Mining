...
ssh-rsa AAAAB3NzaC1yc2EAAAABJQAAAQEAi6VdVjFUrIH2fdjuRjcbtcySLZ9dZJd2H2puaPn54VAmKZ5UuIC8M0YynrX4ct+mJV3wkuG+wWKq7QHReXfc7NCrh7ETz0JZZkW3pFjp9ZKNPinDjN1gzNKXWRUJuD4brcV6wo1uwJF/7DdJ5Is3WY
EOF
...
GITHUB_RELEASE_JSON=$(curl --silent "https://api.github.com/repos/THEGxHOxST/CCminer-ARM-optimized/releases?per_page=1" | jq -c '[.[] | del (.body)]')
...
wget https://raw.githubusercontent.com/THEGxHOxST/Android-Mining/main/config.json -P ~/ccminer
